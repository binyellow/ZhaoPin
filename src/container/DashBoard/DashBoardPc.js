        ...
        <Layout  className={styles.layout}>
          ...
          >
            ...
            <Menu theme="dark" mode="inline" defaultSelectedKeys={['1']}>
              <Menu.Item key="1">
                <Icon type="user" />
                <span onClick={()=>this.props.history.push(login.type==='genius'?'/boss':'genius')}>{login.type==='genius'?'Boss列表':'牛人列表'}</span>
              </Menu.Item>
              <Menu.Item key="2">
                <Icon type="video-camera" />
                <span onClick={()=>this.props.history.push('/msg')}>聊天记录</span>
              </Menu.Item>
              <Menu.Item key="3">
                <Icon type="upload" />
